...
import { HTTP_METHODS } from '../../types/excel'
import type { InterfaceYamlCase } from '../../types/yaml'
...
const currentCase = computed(() => yamlStore.currentCase as InterfaceYamlCase | null)
...
function updateField(field: string, value: unknown) {
  yamlStore.updateInterfaceField(field as keyof InterfaceYamlCase, value)
}
...
<template>
  <div class="interface-form" v-if="currentCase">
